...
exports.seed = async function(knex) {
    ...
    await knex('transactor').insert([
        ...
        {
            id: 'c349163f-8f41-466e-91ec-1ba84e6731c0',
            scenario_id: scenarioUuid,
            description: 'Keep',
            created_on: new Date().toISOString(),
            updated_on: new Date().toISOString(),
        ...
        {
            id: 'ee2ef636-ffe1-441f-b7ef-86f43b6afaff',
            scenario_id: scenarioUuid,
            description: 'Juline',
            created_on: new Date().toISOString(),
            updated_on: new Date().toISOString(),
        ...
        {
            id: 'fa4e4880-0c6f-4465-b202-93df5a9b08b7',
            scenario_id: scenarioUuid,
        ...
        {
            id: '0b14a04d-9653-40f5-8696-9f0631af75fb',
            scenario_id: scenarioUuid,
        ...
        {
            id: '61c6dc20-63b2-42d8-8b6b-2c8eca102753',
            scenario_id: scenarioUuid,
            description: 'Patreon',
            created_on: new Date().toISOString(),
            updated_on: new Date().toISOString(),
