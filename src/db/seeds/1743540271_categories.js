...
exports.seed = async function (knex) {
    ...
    await knex('category').insert([
        ...
        },
        {
            ...
            label: 'Dog',
            description:
                'Dog specific costs separate from food (dog food considered groceries).',
            colour: '#eca252',
            created_on: new Date(),
            updated_on: new Date(),
        },
        ...
        },
        {
            ...
            label: 'Hobbies',
            description:
                'Anything related to recrational activities / equipment',
            colour: '#3bc1d4',
            created_on: new Date(),
            updated_on: new Date(),
        },
        ...
        },
        {
            ...
            label: 'Utilities',
            description:
                'Generic category for any home-related bills or utility payments',
            colour: '#fb701a',
            created_on: new Date(),
            updated_on: new Date(),
        },
