...
exports.up = function (knex) {
    return knex.schema.createTable('scenario_card_bridge', (table) => {
        ...
        table.datetime('show_start_date').defaultTo(knex.fn.now());
        table.datetime('show_end_date').defaultTo(null);
